...
Other language version: [English version](EN.md)

無障礙閱讀說明：本文檢核表以空方框符號（□）表示尚未勾選的核取方塊；日期以西元日期為主，並於括號補充民國日期。關於修訂歷史中之「原稿頁數」為 Pdf 版本之頁數。

## 文件修訂歷史 <span id="document-revision-history"></span>

| 版本 | 變更內容摘要 | 原稿頁數 | 發布日期 |
| --- | --- | --- | --- |
| V1.0 | 初版制定 | 88 | 2025-10-15（民國 114 年 10 月 15 日） |
| V1.1 | 初版修改（完稿第一版） | 97 | 2025-12-01（民國 114 年 12 月 1 日） |
| V2.0 | 完稿第二版 | 97 | 2025-12-05（民國 114 年 12 月 5 日） |
| V2.1 | 完稿修訂版 | 88 | 2025-12-15（民國 114 年 12 月 15 日） |
| V2.2 | 完稿第三版 | 89 | 2025-12-24（民國 114 年 12 月 24 日） |
| V2.3 | 新增附錄連結，開放原始碼促進會（OSI）之開源 AI 定義（OSAID）供參考，並調整中英文 markdown 版本結構，以裨對照查找。 | 79 | 2026-05-15（民國 115 年 5 月 15 日） |
...
## 緒論 <span id="introduction"></span>

### 緣起 <span id="origin"></span>
...
![拼圖人物象徵公部門透過開源軟體與公共程式協作解決資訊系統挑戰](assets/zh-tw-image6.png "緒論：開源軟體與公共程式帶來協作契機")

## 第一章 開源軟體介紹 <span id="chapter-1-introduction-to-open-source-software"></span>

### 1.1 開源軟體發展背景 <span id="1-1-how-it-started"></span>
...
![紅色教堂圖示代表由專屬團隊集中控管且更新較慢的大教堂開發模式](assets/zh-tw-image8.png "大教堂模式：集中式軟體開發")

![市集模式插圖代表公開分散式開發、多人參與、快速修正與頻繁發行](assets/zh-tw-image7.jpeg "市集模式：公開協作與快速迭代")
...
### 1.2 開源軟體國際趨勢與應用 <span id="1-2-international-trends-and-applications"></span>

本節將說明國際上其他政府機關應用開源軟體的三個案例，這些案例將帶我們了解公部門採用開放原始碼的主要趨勢。

#### 1.2.1 德國聯邦政府主導開發 openDesk <span id="1-2-1-german-federal-government-led-the-development-of-opendesk"></span>

![openDesk 功能總覽畫面展示辦公協作、檔案、郵件、通訊與專案管理等模組](assets/zh-tw-image9.png "openDesk 功能示意圖")
...
#### 1.2.2 聯合國提出「數位公共財」的概念 <span id="1-2-2-un-proposes-digital-public-goods"></span>
...
![聯合國數位公共財圖示，列出開放資料、開源軟體、開放內容、開放標準與開放人工智慧模型五類](assets/zh-tw-image12.png "聯合國《秘書長數位合作路線圖》五大數位公共財")

#### 1.2.3 美國的《聯邦程式碼政策》 <span id="1-2-3-the-us-federal-source-code-policy"></span>
...
![美國 Federal Source Code Policy 備忘錄首頁截圖，呈現政策文件標題與發布資訊](assets/zh-tw-image10.png "美國 Federal Source Code Policy 備忘錄")

*圖片來源：[美國 Federal Source Code Policy 備忘錄 https://obamawhitehouse.archives.gov/sites/default/files/omb/memoranda/2016/m_16_21.pdf](https://obamawhitehouse.archives.gov/sites/default/files/omb/memoranda/2016/m_16_21.pdf)。*

### 1.3 開源軟體基本概念與授權條款類型 <span id="1-3-basic-concept-and-licensing-agreement-types-of-open-source-software"></span>
...
#### 1.3.1 GPL 類：AGPL、GPL、LGPL <span id="1-3-1-gpl-agpl-gpl-lgpl"></span>
...
![GPL 家族著作權規範強度圖，由寬鬆到嚴謹排列 LGPL、GPL 與 AGPL 的授權義務](assets/zh-tw-image13.png "GPL 家族著作權規範強度")
...
![開源授權條款著作權規範強度光譜圖，由嚴謹到寬鬆列出 GPL 類、MPL v2、Apache License v2、MIT License、Boost Software License 1.0 與 The Unlicense](assets/zh-tw-image14.png "開源授權條款著作權規範強度光譜")

### 1.4 開源軟體與公共程式 <span id="1-4-open-source-software-and-public-code"></span>
...
![開源軟體與公共程式關係圖，說明公共程式奠基於開源軟體並以公共預算、公共程式、公開存取、授權與用途為核心](assets/zh-tw-image11.png "開源軟體與公共程式關係")

## 第二章 開源軟體應用評估 <span id="chapter-2-open-source-software-application-evaluation"></span>

### 2.1 使用開源軟體及專有軟體差異說明 <span id="2-1-difference-between-using-open-source-and-proprietary-software"></span>
...
### 2.2 開源軟體使用效益與風險評估 <span id="2-2-open-source-software-benefits-and-risks-analysis"></span>

在 2.1 小節裡面，我們完整地比較了專有軟體和開源軟體在不同面向的差異，本節中，我們將總結開源軟體的效益並了解潛在風險，以利各機關在評估與管理開源軟體時，可以充分理解其優勢及導入時的關注重點，針對實務需求及機關資訊環境，進行適宜決策。

#### 2.2.1 開源軟體的使用效益 <span id="2-2-1-open-source-software-benefits"></span>
...
![開源軟體使用效益圖，以政策與公共價值、財務成本可預期性、合作廠商選擇彈性、安全管理自主性、高度系統整合力與高度客製化能力說明六項效益](assets/zh-tw-image15.png "開源軟體使用效益")

#### 2.2.2 使用開源軟體風險評估 <span id="2-2-2-risk-analysis-of-open-source-software"></span>
...
![手繪人物舉起流程圖與文件，象徵導入開源軟體時的轉型風險與維護責任風險](assets/zh-tw-image16.png "開源軟體風險意象")
...
### 2.3 開源軟體導入模式 <span id="2-3-open-source-software-implementation-model"></span>
...
#### 2.3.1 開發策略選擇：應用、整合或自主開發？ <span id="2-3-1-development-strategy-adopt-integrate-or-self-build"></span>
...
![開放優先安全治理圖，以 Open First 為核心，連結密鑰與憑證分離、自動化掃描審查及負責任漏洞回報機制](assets/zh-tw-image22.png "Open First 開放優先安全治理")

#### 2.3.2 查找專案及可參考的平臺 <span id="2-3-2-explore-projects-and-referenceable-platform"></span>
...
### 2.4 開源軟體治理制度 <span id="2-4-open-source-software-governance-system"></span>
...
#### 2.4.1 鼓勵制定開源軟體政策 <span id="2-4-1-open-source-software-governance-system"></span>
...
#### 2.4.2 開源軟體政策及軟體物料清單 <span id="2-4-2-open-source-software-policy-and-software-bill-of-materials"></span>
...
![FLOSS-PSO 公部門 OSPO 全球網絡地圖，標示歐洲、北美、亞洲與非洲等地公共部門 OSPO 社群分布](assets/zh-tw-image23.png "FLOSS-PSO 公部門 OSPO 全球網絡")

*CC By 4.0 “FLOSS-PSO 網絡地圖” 資料來源：OSPO 聯盟*

#### 2.4.3 開源合規國際標準介紹 <span id="2-4-3-introduction-to-international-open-source-compliance-standards"></span>
...
## 第三章 開源軟體導入方法 <span id="chapter-3-open-source-software-implementation"></span>

### 3.1 軟體開發流程：需求與設計開源注意事項 <span id="3-1-software-development-process-needs-and-cautions-when-designing-open-source-software"></span>

開源需求評估階段的執行重點在於確認機關的業務目標與技術需求，並搭配現有系統與資源的梳理，評估開源方案的功能適配性、安全性、社群活躍度與維護能力，並分析長期成本與風險，以確保選用的開源技術或專案，可達成專案之預期成效。

#### 3.1.1 開源軟體評估與選型流程 <span id="3-1-1-open-source-software-evaluation-and-type-selection-process"></span>
...
![X-Road 架構圖展示政府、服務提供者、資料庫與安全伺服器透過安全交換層互通](assets/zh-tw-image24.png "X-Road 模組化資料交換架構")

*圖片來源：X-Road*

承繼著於需求與設計階段建立的彈性基礎及開源套件的選型，開發與測試階段依然需延續著前述開源的精神，善用前置時期建立的相關利害關係人資源及自動化的管理，以利確保開源專案開發品質。

### 3.2 軟體開發流程：開發與測試開源注意事項 <span id="3-2-software-development-process-considerations-for-open-source-during-development-and-testing"></span>

#### 3.2.1 上游優先：避免「開發過多分枝疲勞」 <span id="3-2-1-upstream-first-avoid-fork-fatigue"></span>
...
#### 3.2.2 版本控制與自動化整合 <span id="3-2-2-version-control-and-automated-integration"></span>
...
### 3.3 軟體開發流程：上線與驗收開源注意事項 <span id="3-3-software-development-process-open-source-considerations-for-go-live-and-acceptance"></span>

#### 3.3.1 開源軟體授權合規檢核（表）與風險控管建議 <span id="3-3-1-open-source-software-license-compliance-review-checklist-and-risk-management-recommendations"></span>
...
#### 3.3.2 驗收的核心：可轉移性、可讀性與永續性 <span id="3-3-2-the-core-of-acceptance-transferability-readability-and-sustainability"></span>
...
#### 3.3.3 對標國際標準：以公共程式標準評估專案完成度 <span id="3-3-3-aligning-with-international-standards-assessing-project-completion-using-the-public-code-standard-framework"></span>
...
### 3.4 將開發成果開源釋出 <span id="3-4-releasing-development-outcomes-as-open-source"></span>

#### 3.4.1 維護政府開源專案的要點 <span id="3-4-1-key-governance-considerations-for-public-code"></span>
...
![公共程式維護等級圖以樹木階層呈現從封存、官方維護到社群託管等不同維護成熟度](assets/zh-tw-image25.png "公共程式維護等級")
...
#### 3.4.2 建立清晰友善的社群貢獻機制 <span id="3-4-2-establishing-clear-and-friendly-community-contribution-processes"></span>
...
#### 3.4.3 積極的社群支持與互動 <span id="3-4-3-active-community-support-and-engagement"></span>
...
## 第四章 開源軟體維護與營運 <span id="chapter-4-open-source-software-maintenance-and-operations"></span>

### 4.1 開源軟體維運 <span id="4-1-open-source-software-operations-and-maintenance"></span>
...
#### 4.1.1 系統監控 <span id="4-1-1-system-monitoring"></span>
...
![Grafana 監控儀表板截圖，呈現時間序列圖表、狀態指標與多組監控面板](assets/zh-tw-image26.png "Grafana 系統監控儀表板")

*圖片來源：Grafana.com*

#### 4.1.2 日誌管理 <span id="4-1-2-log-management"></span>
...
#### 4.1.3 容量管理 <span id="4-1-3-capacity-management"></span>
...
#### 4.1.4 資安管理 <span id="4-1-4-information-security-management"></span>
...
![資安管理關鍵項目圖，整理身分驗證、權限控管、資料加密、防火牆設定、入侵偵測、弱點維護與日誌稽核](assets/zh-tw-image27.png "資安管理關鍵項目")

#### 4.1.5 功能維護 <span id="4-1-5-functional-maintenance"></span>
...
#### 4.1.6 版本控管 <span id="4-1-6-version-control"></span>
...
![GitHub 版本控管流程圖，以八個步驟呈現建立 Issue、建立分支、提交、Push、PR、Code Review、合併與發布](assets/zh-tw-image17.png "GitHub 版本控管流程示例")
...
#### 4.1.7 文件管理 <span id="4-1-7-documentation-management"></span>
...
![文件管理與交付矩陣，以表格整理需求、設計、開發、測試、部署與維運階段所需文件](assets/zh-tw-image28.png "文件管理與交付矩陣")

![文件重要性圖例以三種顏色標示必備核心文件、建議文件與特定情境文件](assets/zh-tw-image29.png "文件重要性圖例")

### 4.2 開源軟體永續經營 <span id="4-2-sustainable-operations"></span>
...
#### 4.2.1 開源人才培育與文化形塑 <span id="4-2-1-open-source-talent-development-and-culture-building"></span>
...
#### 4.2.2 社群動態追蹤與持續整合 <span id="4-2-2-community-activity-monitoring-and-continuous-integration"></span>
...
#### 4.2.3 系統管理與升級策略建立 <span id="4-2-3-establishing-system-management-and-upgrade-strategies"></span>
...
#### 4.2.4 授權條款管理與程式碼再利用 <span id="4-2-4-license-management-and-code-reuse"></span>
...
#### 4.2.5 連結社群與公共程式平臺 <span id="4-2-5-connecting-communities-and-public-code-platforms"></span>
...
### 4.3 結語 <span id="4-3-conclusion"></span>
...
## 附錄一 名詞解釋 <span id="appendix-i-terminology"></span>
...
## 附錄二 常見問答 FAQ <span id="appendix-ii-faq"></span>
...
## 附錄三 參考資源 <span id="appendix-iii-links"></span>

- [數位發展部公共程式平臺 https://code.gov.tw/](https://code.gov.tw/)
- [公共程式標準：Standard for Public Code, Guidance for government open source collaboration https://standard.publiccode.net/](https://standard.publiccode.net/)
- [開放原始碼促進會 Open Source Initiative https://opensource.org/](https://opensource.org/)
- [開放原始碼促進會 AI 開源定義 Open Source AI Definition https://opensource.org/ai/open-source-ai-definition](https://opensource.org/ai/open-source-ai-definition)
- [開放原始碼促進會開源軟體授權條款認證清單 https://opensource.org/licenses](https://opensource.org/licenses)
- [開源軟體與公共程式實例說明：openDesk https://www.openDesk.eu/en/about](https://www.openDesk.eu/en/about)

## 附錄四 需求規劃自主檢核表 <span id="appendix-iv-requirements-planning-self-assessment-checklist"></span>
...
無障礙閱讀說明：下列表格中的空方框符號（□）表示尚未勾選的核取方塊。
...
## 附錄五 授權合規評估檢核表 <span id="appendix-v-license-compliance-assessment-checklist"></span>
...
[^6]: [開放原始碼定義（Open Source Definition, OSD）https://opensource.org/osd](https://opensource.org/osd)。
[^7]: [Linux 與 Windows 網站使用統計比較 https://w3techs.com/technologies/comparison/os-linux%2Cos-windows](https://w3techs.com/technologies/comparison/os-linux%2Cos-windows)。
[^8]: [Docker Engine 授權說明文件 https://docs.docker.com/engine/#licensing](https://docs.docker.com/engine/#licensing)。
[^9]: [Kubernetes 官方網站 https://kubernetes.io/](https://kubernetes.io/)。
[^10]: [PyTorch 介紹 https://en.wikipedia.org/wiki/PyTorch](https://en.wikipedia.org/wiki/PyTorch)。
[^11]: [TensorFlow GitHub repository https://github.com/tensorflow/](https://github.com/tensorflow/)。
[^12]: [NumPy 介紹 https://en.wikipedia.org/wiki/NumPy](https://en.wikipedia.org/wiki/NumPy)。
...
[^26]: FLOSS PSO：由開源社群志工主導、由 OSPO 聯盟支援的全球性社群，專為公共部門組織內設置或運作 OSPO 的機構建立。它蒐集、整理各國公共機構的 OSPO 名單與做法，促進經驗交流、政策共創與合作機會，旨在讓開放原始碼精神在政府界落地生根。參考 [FLOSS PSO network https://floss-pso.network/](https://floss-pso.network/)。
...
[^28]: 公共程式標準：專為公部門設計的開源專案品質框架，中文版可參考 [公共程式標準繁體中文版 https://pdis.github.io/publiccodenet.standard/](https://pdis.github.io/publiccodenet.standard/)。
